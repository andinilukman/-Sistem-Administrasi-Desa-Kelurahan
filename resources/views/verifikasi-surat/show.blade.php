...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1" style="color: var(--sidebar-blue);">Detail Verifikasi Surat</h3>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: var(--radius);">
            ...
            <div class="card-body p-4">
                    ...
                    <div class="col-12">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <th class="text-muted fw-medium py-2 align-middle">Catatan Admin</th>
                                    <td class="py-2">
                                        @if($pengajuanSurat->keterangan)
                                            <div class="alert alert-secondary mb-0 p-2 border-0">
                                                {{ $pengajuanSurat->keterangan }}
                                            </div>
                                        @else
                                            <em class="text-muted">Tidak ada catatan admin.</em>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="mt-4 pt-3 border-top d-flex gap-2">
                    <a href="{{ route('verifikasi-surat.index') }}" class="btn btn-light" style="border-radius: 8px;">
                        <i class="bi bi-arrow-left me-1"></i> Kembali
                    </a>
                    <a href="{{ route('verifikasi-surat.edit', $pengajuanSurat->id) }}" class="btn btn-primary ms-auto" style="border-radius: 8px;">
                        <i class="bi bi-check2-circle me-1"></i> Lakukan Verifikasi
                    </a>
                </div>
            </div>
        </div>
