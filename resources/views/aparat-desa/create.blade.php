...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1" style="color: var(--sidebar-blue);">Tambah Aparat Desa</h3>
        <p class="text-muted mb-0">Masukkan informasi detail aparat desa baru.</p>
    </div>
    ...
    <div class="col-xl-9">
        <div class="card border-0 shadow-sm" style="border-radius: var(--radius);">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                <h5 class="fw-bold" style="color: var(--sidebar-blue);"><i class="bi bi-person-plus text-primary me-2"></i>Form Aparat Desa</h5>
            </div>
            
            <div class="card-body p-4">
                <form action="{{ route('aparat-desa.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="foto" class="form-label fw-medium">Upload Foto</label>
