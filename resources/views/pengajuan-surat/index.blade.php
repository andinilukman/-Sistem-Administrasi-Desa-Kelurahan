...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1" style="color: var(--sidebar-blue);">Data Pengajuan Surat</h3>
        <p class="text-muted mb-0">Kelola administrasi pengajuan surat masyarakat.</p>
    </div>
...
<div class="card border-0 shadow-sm" style="border-radius: var(--radius);">
    <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    @if(request()->hasAny(['search', 'status', 'jenis_surat']))
                        <a href="{{ route('pengajuan-surat.index') }}" class="btn btn-light" title="Reset Filter"><i class="bi bi-arrow-clockwise"></i></a>
                    @endif
                </div>
            </div>
        </form>
        ...
        <div class="d-flex justify-content-end mt-3">
            <a href="{{ route('pengajuan-surat.create') }}" class="btn btn-primary" style="border-radius: 8px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <a href="{{ route('pengajuan-surat.show', $pengajuan->id) }}" class="btn btn-sm btn-info text-white" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('pengajuan-surat.edit', $pengajuan->id) }}" class="btn btn-sm btn-warning text-white" title="Ubah">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-danger btn-delete" data-id="{{ $pengajuan->id }}" title="Hapus">
                                    <i class="bi bi-trash"></i>
                                </button>
                                
                                <form id="delete-form-{{ $pengajuan->id }}" action="{{ route('pengajuan-surat.destroy', $pengajuan->id) }}" method="POST" class="d-none">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-4 text-muted">
                            ...
                            Belum ada data Pengajuan Surat yang tersimpan.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
