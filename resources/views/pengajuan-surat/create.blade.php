...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1" style="color: var(--sidebar-blue);">Buat Pengajuan Surat</h3>
        <p class="text-muted mb-0">Formulir pendaftaran pengajuan surat baru.</p>
    </div>
    ...
    <div class="col-xl-9">
        <div class="card border-0 shadow-sm" style="border-radius: var(--radius);">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                <h5 class="fw-bold" style="color: var(--sidebar-blue);"><i class="bi bi-envelope-plus text-primary me-2"></i>Form Pengajuan Surat</h5>
            </div>
                ...
                <form action="{{ $formAction }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light @error('nomor_surat') is-invalid @enderror" id="nomor_surat" name="nomor_surat" value="{{ old('nomor_surat', $nomorSurat) }}" readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_pengajuan') is-invalid @enderror" id="tanggal_pengajuan" name="tanggal_pengajuan" value="{{ old('tanggal_pengajuan', \Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('keperluan') is-invalid @enderror" id="keperluan" name="keperluan" rows="3" placeholder="Jelaskan secara singkat keperluan pembuatan surat..." required>{{ old('keperluan') }}</textarea>
                        @error('keperluan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="status" class="form-label fw-medium">Status Awal <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="2" placeholder="Catatan internal jika ada...">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
